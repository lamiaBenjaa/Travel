    ...
    return (
        <div className='p-6 grid md:grid-cols-2 gap-8  w-full h-fit'>
          ...
          variants={{
            ...
            visible:{opacity:1 ,x:0 ,transition:{duration:1, delay:0.25 ,staggerChildren:2}},
          }}
          initial='hidden'
          whileInView='visible'
           className='text-center  md:col-span-2 h-fit p-5'>
               ...
               <motion.p
                 ...
                 initial='hidden'
                 whileInView='visible' 
                className='font-B text-lg'>Find trips fit a flexible lifestyle</motion.p>
          </motion.div>
          <motion.div 
          variants={{
            hidden:{opacity:0 , x:-60},
          ...
          initial='hidden'
          whileInView='visible'
          className=' p-10 space-y-6 md:space-y-2 xl:space-y-12 lg:p-20 xl:p-32'>
          ...
          <motion.div
           ...
           initial='hidden'
           whileInView='visible'
           className=' px-16 py-6 md:py-16 md:px-3 lg:px-12 xl:px-36 xl:py-32  relative '>
            <img src={img} className='m-auto rounded-[40px] place-items-center  max-h-[900px] md:max-h-[530px]   xl:max-h-[650px] '/>
